 ...
 * @author ENMA
 */
public class addDialogKriteria extends javax.swing.JDialog {
    private Connection conn = new Koneksi().connect();

    /**
     * Creates new form CobaDialog
     */
    public addDialogKriteria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        private void insertDataPaket(){        
            String sql = "INSERT INTO kriteria VALUES (?,?, 0.000)";
                try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addDialogKriteria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                addDialogKriteria dialog = new addDialogKriteria(new javax.swing.JFrame(), true);
